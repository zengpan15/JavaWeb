...
public class BorrowServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (tip == 1) {
            ...
            response.sendRedirect("/manage/book/user/select.jsp");
        } else {
            //还书功能，获取借阅记录的hid
            ...
            if (show == 1) {
                response.sendRedirect("/manage/book/user/borrow.jsp");
            } else {
                response.sendRedirect("/manage/book/admin/admin_borrows.jsp");
            }
